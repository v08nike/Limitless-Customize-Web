/* ------------------------------------------------------------------------------
 *
 *  # Buttons extension for Datatables. PDF examples
 *
 *  Demo JS code for datatable_extension_buttons_pdf.html page
 *
 * ---------------------------------------------------------------------------- */
...
const DatatableButtonsPdf = function() {
    ...
    const _componentDatatableButtonsPdf = function() {
        if (!$().DataTable) {
        ...
        // Message
        $('.datatable-pdf-message').DataTable({
            buttons: {
                dom: {
                    button: {
