...
const SecondaryPalette = function() {
    ...
    const _componentPopups = function() {
        ...
        if(customTooltipElement) {
            new bootstrap.Tooltip(customTooltipElement, {
                ...
                template: '<div class="tooltip" role="tooltip"><div class="tooltip-arrow border-secondary"></div><div class="tooltip-inner bg-secondary text-white"></div></div>'
            });
        }
        ...
        if(customPopoverElement) {
            new bootstrap.Popover(customPopoverElement, {
                ...
                template: '<div class="popover bg-secondary border-secondary"><div class="popover-arrow border-secondary"></div><h3 class="popover-header bg-secondary text-white border-white border-opacity-25"></h3><div class="popover-body text-white"></div></div>'
            });
        }
    };
