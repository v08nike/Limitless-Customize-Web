    ...
    const _componentPopups = function() {
        ...
        if(customTooltipElement) {
            new bootstrap.Tooltip(customTooltipElement, {
                ...
                template: '<div class="tooltip" role="tooltip"><div class="tooltip-arrow border-success"></div><div class="tooltip-inner bg-success text-white"></div></div>'
            });
        }
        ...
        if(customPopoverElement) {
            new bootstrap.Popover(customPopoverElement, {
                ...
                template: '<div class="popover bg-success border-success"><div class="popover-arrow border-success"></div><h3 class="popover-header bg-success text-white border-white border-opacity-25"></h3><div class="popover-body text-white"></div></div>'
            });
        }
    };
