    ...
    const _componentPopups = function() {
        ...
        if(customTooltipElement) {
            new bootstrap.Tooltip(customTooltipElement, {
                ...
                template: '<div class="tooltip" role="tooltip"><div class="tooltip-arrow border-danger"></div><div class="tooltip-inner bg-danger text-white"></div></div>'
            });
        }
        ...
        if(customPopoverElement) {
            new bootstrap.Popover(customPopoverElement, {
                ...
                template: '<div class="popover bg-danger border-danger"><div class="popover-arrow border-danger"></div><h3 class="popover-header bg-danger text-white border-white border-opacity-25"></h3><div class="popover-body text-white"></div></div>'
            });
        }
    };
