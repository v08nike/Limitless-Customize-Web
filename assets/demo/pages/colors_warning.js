    ...
    const _componentPopups = function() {
        ...
        if(customTooltipElement) {
            new bootstrap.Tooltip(customTooltipElement, {
                ...
                template: '<div class="tooltip" role="tooltip"><div class="tooltip-arrow border-warning"></div><div class="tooltip-inner bg-warning text-white"></div></div>'
            });
        }
        ...
        if(customPopoverElement) {
            new bootstrap.Popover(customPopoverElement, {
                ...
                template: '<div class="popover bg-warning border-warning"><div class="popover-arrow border-warning"></div><h3 class="popover-header bg-warning text-white border-white border-opacity-25"></h3><div class="popover-body text-white"></div></div>'
            });
        }
    };
