/* ------------------------------------------------------------------------------
 *
 *  # Echarts - Candlestick with line example
 *
 *  Demo JS code for candlestick chart with line [light theme]
 *
 * ---------------------------------------------------------------------------- */
...
var EchartsCandlestickLineLight = function() {
    ...
    // Candlestick chart with line
    var _candlestickLineLightExample = function() {
        ...
        if (candlestick_line_element) {
            ...
            // Initialize chart
            var candlestick_line = echarts.init(candlestick_line_element, null, { renderer: 'svg' });
...
document.addEventListener('DOMContentLoaded', function() {
    EchartsCandlestickLineLight.init();
});
