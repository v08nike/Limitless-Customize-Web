...
const С3BarsPies = function() {
    ...
    // Chart
    const _barsPiesExamples = function() {
        ...
        const pie_chart_element = document.getElementById('c3-pie-chart');
        const donut_chart_element = document.getElementById('c3-donut-chart');
        const bar_chart_element = document.getElementById('c3-bar-chart');
        const bar_stacked_chart_element = document.getElementById('c3-bar-stacked-chart');
        const combined_chart_element = document.getElementById('c3-combined-chart');
        const scatter_chart_element = document.getElementById('c3-scatter-chart');
        ...
        if(bar_stacked_chart_element) {
            ...
            // Generate chart
            const bar_stacked_chart = c3.generate({
        ...
        if(combined_chart_element) {
            ...
            // Generate chart
            const combined_chart = c3.generate({
        ...
        if(scatter_chart_element) {
            ...
            // Generate chart
            const scatter_chart = c3.generate({
                size: { height: 400 },
